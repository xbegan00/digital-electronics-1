...
entity tlc is
  port (
    ...
    notr   : in    std_logic;                     --! no traffic
    cw   : in    std_logic;                     --Car from west
    cs   : in    std_logic;                     --Car from west
...
architecture behavioral of tlc is
  ...
  constant c_BLUE  : std_logic_vector(2 downto 0) := b"001"; --! RGB settings for blue color
  ...
  begin
    ...
    if (rising_edge(clk)) then
      if (rst = '1') then                    -- Synchronous reset
        ...
        --NORMAL
      elsif ((sig_en = '1' or (cw = '1' or cs = '1')) and notr = '0') then
      ...
      --Car WEST
      elsif (sig_en = '1' and cw = '1' and cs = '0' and notr = '0') then
        -- Every 250 ms, CASE checks the value of sig_state
        -- local signal and changes to the next state 
        -- according to the delay value.
        case sig_state is
      ...
      --Car SOUTH
      elsif (sig_en = '1' and cw = '0' and cs = '1' and notr = '0') then
        -- Every 250 ms, CASE checks the value of sig_state
        -- local signal and changes to the next state 
        -- according to the delay value.
        case sig_state is
        ...
        elsif (sig_en = '1' and cw = '0' and cs = '0' and notr = '1') then
        -- Every 250 ms, CASE checks the value of sig_state
        -- local signal and changes to the next state 
        -- according to the delay value.
        case sig_state is
